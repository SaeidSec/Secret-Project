...
\textbf{Version:} 3.1.0 (Ultimate "One-Click" Edition) \\
...
\begin{itemize}
    \item \textbf{\texttt{proxy\_timeout 300s}}: Increased from the default to ensure that long-lived agent TCP connections are not prematurely terminated by the load balancer during a manager election or container restart.
\end{itemize}
